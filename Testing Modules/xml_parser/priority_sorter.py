...
prime_course_list=xml_parser.populate_course_list('../xml_parser/course_data_updated.xml')
...
#    print(i.credits)
bing=0
for i in calendar.semesters:
    for j in i.sem_courses:
        if j.dept_core=="Elective":
            print(j.class_deptnumber,j.credits)
            bing+=j.credits
print(bing)
>>>>>>> a7806e5ea086c4d88df7645f74e04825bf10daab
